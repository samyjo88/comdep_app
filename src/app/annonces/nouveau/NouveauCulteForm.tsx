...
export function NouveauCulteForm({ culteInitial }: Props) {
  const [state, action, isPending] = useActionState(preparerCulte, null)
  const error = state && 'error' in state ? state.error : null

  const isEdit = !!culteInitial
    ...
    <div className="container mx-auto py-10 px-4 max-w-lg">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight">
          {isEdit ? 'Modifier le culte' : 'Nouveau culte'}
        </h1>
        <p className="text-sm text-muted-foreground mt-1.5 max-w-xs mx-auto">
          {isEdit
            ? 'Modifiez les informations du culte avant de préparer les annonces.'
      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <form action={action} className="space-y-5">
            ...
            {/* Champ caché : id du culte existant */}
            {culteInitial && (
              <input type="hidden" name="culte_id" value={culteInitial.id} />
            )}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  required
                  disabled={isPending}
                  defaultValue={culteInitial?.date_culte ?? ''}
                  className="pl-9"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={isPending}
                  defaultValue={culteInitial?.theme ?? ''}
                  className="pl-9"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  disabled={isPending}
                  defaultValue={culteInitial?.predicateur ?? ''}
                  className="pl-9"
                />
              </div>
            </div>
            ...
            >
              {isPending ? (
                ...
                <>
                  {isEdit ? 'Enregistrer et préparer les annonces' : 'Commencer la préparation'}
